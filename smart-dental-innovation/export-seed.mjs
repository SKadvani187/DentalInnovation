...
const out = {
  ...
  site: {
    ...
    gvpPage: site.gvpPage,
    shopByPricePage: site.shopByPricePage,
    navMenu: site.navMenu,
    policies: site.policies,
    offerZoneHero: site.offerZoneHero,
    combosPage: site.combosPage,
    ...
    aboutSections: site.aboutSections,
    contactSections: site.contactSections,
  },
  counts: {
